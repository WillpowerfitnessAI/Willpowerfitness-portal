...
export async function createCheckoutSession(customerId, email, userData) {
  try {
    const session = await stripe.checkout.sessions.create({
      ...
      mode: 'subscription',
      success_url: `${process.env.DOMAIN || 'https://willpowerfitnessai.replit.app'}/success?session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `${process.env.DOMAIN || 'https://willpowerfitnessai.replit.app'}/onboarding`,
      metadata: {
