...
export async function getChatResponse(messages, userContext = {}) {
  try {
    const systemPrompt = {
      role: "system",
      content: `You are WillPower, an autonomous personal training AI assistant. You provide quick, motivational, and personalized fitness advice. Keep responses concise and energetic. User context: ${JSON.stringify(userContext)}`
    };
